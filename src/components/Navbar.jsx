...
const dropdownVariants = {
  hidden: { opacity: 0, y: -8, scale: 0.98, x: "-50%" },
  visible: { opacity: 1, y: 0, scale: 1, x: "-50%", transition: { duration: 0.18, ease: [0.16, 1, 0.3, 1] } },
  exit: { opacity: 0, y: -6, scale: 0.98, x: "-50%", transition: { duration: 0.12 } },
};
